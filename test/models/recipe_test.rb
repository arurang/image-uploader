...
class RecipeTest < ActiveSupport::TestCase
  ...
  @recipe = @chef.recipes.build(name:"Chicken parm",summary:"This is the best chicken param recipe ever",
...
test "chef_id should be presence" do
@recipe.chef_id = nil
assert_not @recipe.valid?
 ...
 #==================================================== 
  ...
  test "name length shouuld not be too short" do
   @recipe.name="aaaa"
   assert_not @recipe.valid? 
  end
